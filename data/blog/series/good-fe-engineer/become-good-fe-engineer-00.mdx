...
그런데 저는 개발, 그 중에서도 프론트엔드를 사랑합니다. 그 누구도 본 적 없는 인터렉션, UI를 통해 유저들의 놀라움을 볼 때면 그런 고생이 다 잊혀지는 것 같습니다. 제가 진심인 이 분야를, 오래오래 더 발전시키고 싶습니다. 언젠가 이 분야에 진심인 분들과 함께 일하는 날이 오길.
