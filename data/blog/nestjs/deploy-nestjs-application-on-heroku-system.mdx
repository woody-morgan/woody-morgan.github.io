---
title: Deploy Nestjs Application on Heroku System
date: '2022-08-07'
tags: ['backend', 'nestjs']
draft: false
...
해당 문제는 제가 오픈소스로 풀어놓은 [nestify](https://github.com/woodi97/nestify/blob/main/src/shared/services/api-config.service.ts) 저장소에 있는 파일에서 발생했습니다.
